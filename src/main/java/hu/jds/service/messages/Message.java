...
public abstract class Message {
    ...
    public byte[] generate(int nodeId) throws IOException {
        ...
        Assert.isTrue(msg.length <= MAX_BUFSIZE, "Message exceeds maximum buffer size");
    ...
    protected static int byteToInt(InputStream source) throws IOException {
        byte[] b = new byte[4];
        source.read(b);
